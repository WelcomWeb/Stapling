...
;(function (window, document, undef) {
    ...
    */
    if (typeof window.Stapling !== typeof undef) {
        return;
    }
    ...
    */
    ...
    var Stapling = function () {
        ...
        */
        var isIE = typeof window.DOMParser === typeof undef || typeof window.XSLTProcessor === typeof undef;
        ...
        */
        var _fullXmlString = function (xmlPart) {
            ...
            var xml = '<' + '?xml version="1.0" encoding="UTF-8" ?' + '><json>' + xmlPart + '</json>';
            return xml;
        ...
        */
        ...
        /**
        * Store a template (as string) for the specified resource URI
        *
        ...
        */
        ...
        return {
            ...
            * browser (IE8+ or fallback libraries)
            *
            * @returns {Boolean}
            */
            ...
            */
            ...
            /**
            * Clear the cache for the specified XSLT resource template
            *
            * @param xslt {String} An URI for a XSLT template
            * @returns {Void}
            */
            clear: function (name) {
